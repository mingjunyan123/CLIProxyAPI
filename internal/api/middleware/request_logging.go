...
// When full request logging is enabled, selected outbound requests are handled by executor helpers.
// When full request logging is disabled, large and unknown-size bodies are spooled to disk and
// retained only for error logs.
