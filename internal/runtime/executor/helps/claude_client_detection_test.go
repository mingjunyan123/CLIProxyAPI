...
func TestDetectClaudeCodeRequestClassifiesEntrypoints(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "local-agent", userAgent: "claude-cli/2.1.220 (external, local-agent, agent-sdk/0.3.220)", entrypoint: "local-agent", subclient: "claude-local-agent", agentSDKVersion: "0.3.220", native: true},
		{name: "desktop", userAgent: "claude-cli/2.1.220 (external, claude-desktop)", entrypoint: "claude-desktop", subclient: "claude-desktop"},
		{name: "desktop-third-party-inference", userAgent: "claude-cli/2.1.220 (external, claude-desktop-3p)", entrypoint: "claude-desktop-3p", subclient: "claude-desktop-3p", native: true},
